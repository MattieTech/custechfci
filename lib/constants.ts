...
export const NAV_LINKS = [
  ...
  { href: '/resources', label: 'Study Materials & Vault', icon: 'book' },
  { href: '/cbt', label: 'CBT Drill', icon: 'zap' },
  { href: '/cgpa', label: 'CGPA Calculator', icon: 'calculator' },
  { href: '/ai-tutor', label: 'Ask FCI AI', icon: 'bot' },
  { href: '/timetable', label: 'Timetable', icon: 'calendar' },
  { href: '/calendar', label: 'Academic Calendar', icon: 'calendar' },
  { href: '/grievances', label: 'Guild Grievances', icon: 'inbox' },
  { href: '/lost-and-found', label: 'Lost & Found', icon: 'search' },
  { href: '/news', label: 'News & Updates', icon: 'newspaper' },
  { href: '/contacts', label: 'Course Reps & Contacts', icon: 'mail' },
  { href: '/about', label: 'About FCI', icon: 'info' },
];
