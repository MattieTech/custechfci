...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="font-body bg-brand-50 text-brand-950 dark:bg-brand-950 dark:text-brand-50 min-h-screen flex flex-col transition-colors duration-200 overflow-x-clip">
        <ThemeProvider attribute="class" defaultTheme="light" enableSystem={false}>
          ...
          <Header />
          <main id="main-content" className="flex-grow w-full max-w-full overflow-x-clip">
            {children}
          </main>
          <Footer />
